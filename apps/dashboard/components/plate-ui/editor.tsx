...
export function EditorContainer({ className, children, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
...
export function Editor({ className, disabled, readOnly, ...props }: PlateContentProps) {
  return (
    <PlateContent
      className={cn(
