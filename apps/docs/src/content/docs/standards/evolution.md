---
title: API Evolution — What We Learned
description: Lessons learned from the original SiteHaus API and the design decisions that shaped the ecommerce platform.
---
