---
title: NestJS API Standards — SiteHaus Ecommerce
description: NestJS API conventions for the SiteHaus ecommerce platform — contracts, controllers, services, and database access.
---
...
For the rationale behind these choices vs. the existing SiteHaus API, see [Evolution Standards](/standards/evolution).
