---
title: React / Next.js Standards — SiteHaus Dashboard
description: React and Next.js conventions for the SiteHaus dashboard — data fetching, component organization, forms, and TypeScript rules.
---
