...
// Auth still flows through the IAM api (login, refresh, /me). Status data comes
// from lighthaus-api separately (see lib/status-client.ts), authenticated with
// the same access token the SDK keeps fresh in the auth store.
initStoresSdk({
  baseURL: API,
  clientKey: CLIENT,
