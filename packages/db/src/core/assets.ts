...
export const assetReviewStatusEnum = pgEnum("asset_review_status", assetReviewStatusValues);
...
export type AssetReviewStatus = (typeof assetReviewStatusEnum.enumValues)[number];
