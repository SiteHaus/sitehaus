...
export const codeChallengeMethodEnum = pgEnum("code_challenge_method", codeChallengeMethodValues);
...
export const authCodesTable = pgTable(
  "auth_codes",
  {
    ...
    method: codeChallengeMethodEnum("code_challenge_method").notNull().default("S256"),
